const CHATER_SW_VERSION = '2026-07-07-chater-qr-profile-confirmation-152';
...
function shouldServePwaIconFallback(pathname = '') {
  return /\/assets\/(chater-icon-(192|512|fallback)|chater-maskable-(512|fallback)|chater-logo)\.png$/i.test(pathname);
}
