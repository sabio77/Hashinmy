...
assert.match(clientSource, /spaceIds:\s*unresolvedSpaceIds/,
  'La limpieza no puede retirar una membresía huérfana cuando el documento de invitación ya desapareció.');
