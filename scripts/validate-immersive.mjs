...
if (!assetsOnly) {
  ...
  assert(indexHtml.includes('class="hm-whatsapp-float__fallback-outline"') && indexHtml.includes('stroke="#FFFFFF"') && buildScript.includes('class="hm-whatsapp-float__fallback-outline"') && buildScript.includes('stroke="#FFFFFF"'), 'El fallback de WhatsApp debe conservar el contorno interior blanco del logotipo tanto en la portada como en las páginas generadas.');
