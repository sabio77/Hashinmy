...
if (!assetsOnly) {
  ...
  assert(indexHtml.includes('\"@type\": \"FAQPage\"') && indexHtml.includes('https://hashinmy.com/#faq') && indexHtml.includes('¿Por qué contratar a Hashinmy?') && indexHtml.includes('¿Para quién es Hashinmy?') && indexHtml.includes('¿Cómo se inicia un proyecto?'), 'La home debe mantener FAQPage estructurado alineado con el FAQ rápido visible.');
