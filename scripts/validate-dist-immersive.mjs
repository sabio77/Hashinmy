...
assert(
  ...
  assert(indexHtml.includes('class="hm-whatsapp-float__fallback-outline"') && englishIndexHtml.includes('class="hm-whatsapp-float__fallback-outline"') && seoSampleHtml.includes('class="hm-whatsapp-float__fallback-outline"') && seoSampleEnHtml.includes('class="hm-whatsapp-float__fallback-outline"') && buildScript.includes('class="hm-whatsapp-float__fallback-outline"'), 'dist debe conservar el contorno interior blanco del logotipo de WhatsApp en portada, idiomas y páginas SEO generadas.');
